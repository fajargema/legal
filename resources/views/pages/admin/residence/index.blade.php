...
<section class="section">
    <div class="card">
        <div class="card-header">
            <a href="{{ route('admin.residence.create') }}" class="btn icon icon-left btn-primary"><i
            ...
            <table class='table table-striped' id="table1">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                <a href="{{ route('admin.residence.edit', $item->id) }}"
                                    class="btn btn-primary shadow btn-sm sharp" style="margin-right: 2%"
                                    data-toggle="tooltip" title='Edit'>
                                    <i data-feather="edit"></i>
                                </a>
                                <form method="POST" action="{{ route('admin.residence.destroy', $item->id) }}">
                                    @csrf
                                    @method('delete')
